      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12 px-2">
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link href="mailto:info@greendetective.earth" className="block text-gray-300 hover:text-white flex items-center gap-2 text-sm">
                <Mail className="h-4 w-4" />
                info@greendetective.earth
              </Link>
              <Link href="https://www.linkedin.com/company/greendetective" className="block text-gray-300 hover:text-white flex items-center gap-2 text-sm">
                <LinkedinIcon className="h-4 w-4" />
                LinkedIn
              </Link>
              <Link href="https://twitter.com/greendetective" className="block text-gray-300 hover:text-white flex items-center gap-2 text-sm">
                <X className="h-4 w-4" />
                Twitter
              </Link>
            </div>
        ...
        {/* Copyright */}
        <div className="border-t border-white/10 pt-4 sm:pt-6 flex flex-col sm:flex-row justify-between items-center text-sm text-gray-300 space-y-2 sm:space-y-0 px-2">
