...
export function Navigation() {
  ...
  return (
    <header className="sticky top-0 z-50 py-3 px-4 md:px-6 backdrop-blur-sm border-b">
      <nav className="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0 max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center gap-4 md:space-x-4">
          <a href="/" className="text-sm md:text-base text-foreground hover:text-primary transition-colors">
            Home
          </a>
          {isAuthenticated && (
          ...
          {isAuthenticated ? (
            ...
            <a href="/login" className="text-sm md:text-base text-foreground hover:text-primary transition-colors">
              Login
            </a>
          )}
        </div>
